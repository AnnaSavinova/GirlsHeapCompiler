...
#line 176 "tokens.y"
    { 
		...
		std::vector< IVarDecl* > decls = dynamic_cast< ÑFormalList* >((yyvsp[(3) - (3)].formalList))->List();
		decls.insert(decls.begin(), var);
		(yyval.formalList) = new ÑFormalList( decls );
	}
    break;
...
/* Line 1792 of yacc.c  */
#line 182 "tokens.y"
    { (yyval.formalList) = new ÑFormalList( new CVarDecl( (yyvsp[(1) - (2)].type), std::string((yyvsp[(2) - (2)].sval)) ) ); }
    break;

  case 29:
/* Line 1792 of yacc.c  */
#line 183 "tokens.y"
    { (yyval.formalList) = new ÑFormalList((yyvsp[(1) - (1)].varDecl)); }
    break;
...
#line 184 "tokens.y"
    {
		std::vector< IVarDecl* > decls = dynamic_cast< ÑFormalList* >((yyvsp[(1) - (2)].formalList))->List();
		decls.push_back( (yyvsp[(2) - (2)].varDecl) );
		(yyval.formalList) = new ÑFormalList( decls );
	}
    break;
